    ...
    <div class="privacy-notice">
      ...
      <Show when={expanded()}>
        <div class="privacy-notice__details">
          <p>
            When you submit, CaTune sends only: parameter values (tau_rise,
            tau_decay, lambda), AR2 coefficients, sampling rate, your
            experimental metadata (indicator, species, brain region), and a
            dataset fingerprint for duplicate detection.
          </p>
          <p>
            Your raw fluorescence traces, deconvolved activity, and any file
            data remain entirely in your browser's memory. No trace data is
            ever transmitted to any server.
          </p>
          <p>
            Submissions are stored in a Supabase database. You can delete your
            own submissions at any time.
          </p>
        </div>
      </Show>
    </div>
